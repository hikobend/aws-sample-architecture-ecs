...
resource "aws_cloudwatch_log_group" "log_connect_client" {
  name = "/ecs/${var.env}-svccon-client"
}

resource "aws_cloudwatch_log_group" "log_connect_server" {
  name = "/ecs/${var.env}-svccon-server"
}
...
resource "aws_iam_policy" "ecs_exec_policy" {
  name   = "${var.env}-AmazonECSExecPolicy"
...
resource "aws_iam_role" "execution_role" {
  name               = "${var.env}-nginx-execution-role"
  assume_role_policy = data.aws_iam_policy_document.ecs_task_doc.json
}
